...
// GET /api/staffEvents/universityid
// Supports pagination: ?page=1&limit=10
// Supports search: ?q=garden
...
// GET /api/staffEvents/:id
// Get a specific staff event
...
// POST /api/staffEvents/:id/enroll
router.post('/:id/enroll', async (req, res) => {
  try {
    ...
    await sendNotification(
      ...
      { screen: "universityStaff", data:null },
      true
    );
